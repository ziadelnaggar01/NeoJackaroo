...
/**
 * Represents an exception that occurs when an invalid selection is made. This
 * is an abstract class extending GameException, meaning it cannot be
 * instantiated directly. It serves as the base class for more specific
