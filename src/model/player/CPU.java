...
public class CPU extends Player{
	private final BoardManager boardManager; // The current board instance, initialized by the Game class, wrapped as the interface BoardManager, cannot be changed once initialized

	CPU(String name, Colour colour, BoardManager boardManager)
	{
		/**
		 * Constructs a CPU object with the given parameters and initializes the board manager.
		 *
